...
export const cardBase = style({
	...
	boxShadow: `${themeContract.color.shadowLight} -5px -5px 10px, ${themeContract.color.shadowDark} 5px 5px 10px`,
	display: "flex",
...
export const cardHoverable = style({
	":hover": {
		...
		boxShadow: `${themeContract.color.shadowLight} -8px -8px 16px, ${themeContract.color.shadowDark} 8px 8px 16px`,
	},
});
